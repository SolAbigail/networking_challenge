...
package com.example.android.networkconnect.presenter;
...
import com.example.android.networkconnect.presenter.fragment.NetworkFragment;
...
public class MainActivity extends AppCompatActivity implements DownloadCallback {
    ...
    private SampleMainBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = SampleMainBinding.inflate(getLayoutInflater());
    ...
    private void setUpNavigation() {
        ...
        assert navHost != null;
        NavigationUI.setupWithNavController(binding.bottomNavigation, navHost.getNavController());
    }
