...
abstract class Hilt_LocationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LocationFragment() {
    super();
  }

  Hilt_LocationFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LocationFragment_GeneratedInjector) this.generatedComponent()).injectLocationFragment(UnsafeCasts.<LocationFragment>unsafeCast(this));
    }
  }
