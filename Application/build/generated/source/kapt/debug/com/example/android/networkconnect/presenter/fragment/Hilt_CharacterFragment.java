...
abstract class Hilt_CharacterFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CharacterFragment() {
    super();
  }

  Hilt_CharacterFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CharacterFragment_GeneratedInjector) this.generatedComponent()).injectCharacterFragment(UnsafeCasts.<CharacterFragment>unsafeCast(this));
    }
  }
