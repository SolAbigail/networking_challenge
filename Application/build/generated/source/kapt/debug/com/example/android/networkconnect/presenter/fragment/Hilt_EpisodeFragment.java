...
abstract class Hilt_EpisodeFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EpisodeFragment() {
    super();
  }

  Hilt_EpisodeFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EpisodeFragment_GeneratedInjector) this.generatedComponent()).injectEpisodeFragment(UnsafeCasts.<EpisodeFragment>unsafeCast(this));
    }
  }
