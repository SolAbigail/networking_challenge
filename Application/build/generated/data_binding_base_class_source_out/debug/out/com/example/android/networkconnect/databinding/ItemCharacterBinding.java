...
public abstract class ItemCharacterBinding extends ViewDataBinding {
  ...
  @NonNull
  public final TextView tvTitleMovies;

  @Bindable
  protected CharacterModel mCharacter;

  protected ItemCharacterBinding(Object _bindingComponent, View _root, int _localFieldCount,
      ImageView image, TextView tvTitleMovies) {
    super(_bindingComponent, _root, _localFieldCount);
    this.image = image;
    this.tvTitleMovies = tvTitleMovies;
  }

  public abstract void setCharacter(@Nullable CharacterModel character);
